...
func (s *Server) SetupRoutes(r *gin.Engine) {
	...
	admin.Use(s.authService.RequireTokenAuth())
	{
		...
		admin.POST("/channels/batch-common-models", s.HandleGetBatchCommonModels) // 获取批量选中渠道的共有模型
		admin.POST("/channels/batch-edit-models", s.HandleBatchEditModels)        // 批量编辑共有模型重定向
